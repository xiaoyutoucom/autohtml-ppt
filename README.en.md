...
<p align="center">
  <img src="docs/assets/screenshots-en/preview.gif" alt="Tech Training Deck preview — flipable HTML slides" width="900" />
  <br />
...
> Captured with the deck in **English** (L / config.json lang: en). Chinese UI shots live in docs/assets/screenshots/ and [README.zh-CN.md](./README.zh-CN.md).
...
| | |
|--|--|
| <img src="docs/assets/screenshots-en/preview-flip.gif" width="440" alt="Page flip" /><br />**Page flip** — cover → TOC → cards → story → media → quote → overlay → contrast → Stage → live command | <img src="docs/assets/screenshots-en/preview-layouts.gif" width="440" alt="Layouts" /><br />**Layout pack** — Cards / Contrast / Steps / Quote / Overlay / Media-top / Story / Table |
| <img src="docs/assets/screenshots-en/preview-stage.gif" width="440" alt="Stage pulse" /><br />**Stage row pulse** — S0–S9 table lights up row-by-row for live teaching | <img src="docs/assets/screenshots-en/preview-themes.gif" width="440" alt="Themes" /><br />**20 themes** — dark + light cycling in the style picker (`T`) |
| <img src="docs/assets/screenshots-en/preview-chrome.gif" width="440" alt="Chrome tools" /><br />**Presenter chrome** — thumbnail rail (`S`) → grid (`G`) → pen (`A`) → present mode (`F`) | <img src="docs/assets/screenshots-en/preview.gif" width="440" alt="Hero" /><br />**Hero loop** — narrative highlights in one short clip |

### 1) Cover, TOC & narrative

<p align="center"><img src="docs/assets/screenshots-en/01-cover.png" width="900" alt="Cover" /><br /><em>Cover — hero brand, particle/Vanta mesh, chapter preview cards, speaker + live talk time, provenance badge (top-right)</em></p>
<p align="center"><img src="docs/assets/screenshots-en/02-toc.png" width="900" alt="TOC" /><br /><em>Dedicated TOC board — jumpable chapter cards</em></p>
<p align="center"><img src="docs/assets/screenshots-en/16-section-break.png" width="900" alt="Section" /><br /><em>Section break slides — big outlined chapter numbers</em></p>
<p align="center"><img src="docs/assets/screenshots-en/03-story-figure.png" width="900" alt="Story" /><br /><em>Story layout — large figure + talking points (copyright-safe stick-figure art)</em></p>

### 2) Layout system (no more left-right fatigue)

| | |
|--|--|
| <img src="docs/assets/screenshots-en/04-layout-cards.png" width="440" alt="Cards" /><br />Cards | <img src="docs/assets/screenshots-en/05-layout-contrast.png" width="440" alt="Contrast" /><br />Contrast (Before / After) |
| <img src="docs/assets/screenshots-en/06-layout-steps.png" width="440" alt="Steps" /><br />Steps | <img src="docs/assets/screenshots-en/07-layout-quote.png" width="440" alt="Quote" /><br />Quote / formula center |
| <img src="docs/assets/screenshots-en/08-layout-overlay.png" width="440" alt="Overlay" /><br />Overlay (full-bleed figure) | <img src="docs/assets/screenshots-en/09-layout-media-top.png" width="440" alt="Media-top" /><br />Media-top |
| <img src="docs/assets/screenshots-en/10-layout-nested.png" width="440" alt="Nested" /><br />Nested / story reverse | <img src="docs/assets/screenshots-en/12-practice-framework.png" width="440" alt="Practice" /><br />Practice framework |

Also included in the engine (see skill `layouts.md`): **BigNumber · Split · Comparison · Icon-row · Hero**.

### 3) Teaching interactions

<p align="center"><img src="docs/assets/screenshots-en/11-stage-table.png" width="900" alt="Stage" /><br /><em>Stage table — `table.fw-table` + row-by-row `.is-lit` pulse (`data-row-pulse`)</em></p>
<p align="center"><img src="docs/assets/screenshots-en/15-case-cards.png" width="900" alt="Cases" /><br /><em>Success cases — summary + hover/focus detail (projectable orally)</em></p>
<p align="center"><img src="docs/assets/screenshots-en/13-demo-video.png" width="900" alt="Demo" /><br /><em>Demo video page — Space play/pause, pause on leave</em></p>
<p align="center"><img src="docs/assets/screenshots-en/14-live-cmd.png" width="900" alt="Commands" /><br /><em>Live command page — one-click copy for classroom runs</em></p>

### 4) Presenter chrome

| | |
|--|--|
| <img src="docs/assets/screenshots-en/20-chrome-rail.png" width="440" alt="Rail" /><br />Thumbnail rail (`S`) | <img src="docs/assets/screenshots-en/21-chrome-grid.png" width="440" alt="Grid" /><br />Grid overview (`G`) |
| <img src="docs/assets/screenshots-en/22-chrome-annotate.png" width="440" alt="Annotate" /><br />Pen / highlighter / eraser (`A`) | <img src="docs/assets/screenshots-en/23-present-mode.png" width="440" alt="Present" /><br />Present mode (`F`) + footer hot-zone |
| <img src="docs/assets/screenshots-en/24-theme-picker.png" width="440" alt="Picker" /><br />Theme picker (`T`) — 20 styles remembered | |
...
| Dark | Light |
|------|-------|
| <img src="docs/assets/screenshots-en/30-theme-01-deep-space.png" width="420" alt="Theme 1" /><br />#1 深空青光 | <img src="docs/assets/screenshots-en/36-theme-05-polar-ice.png" width="420" alt="Theme 5" /><br />#5 极地冰原 |
| <img src="docs/assets/screenshots-en/31-theme-03-obsidian-amber.png" width="420" alt="Theme 3" /><br />#3 曜石琥珀 | <img src="docs/assets/screenshots-en/37-theme-08-blueprint.png" width="420" alt="Theme 8" /><br />#8 蓝图草稿 |
| <img src="docs/assets/screenshots-en/32-theme-07-coral-reef.png" width="420" alt="Theme 7" /><br />#7 珊瑚暗礁 | <img src="docs/assets/screenshots-en/38-theme-14-porcelain.png" width="420" alt="Theme 14" /><br />#14 瓷白墨线 |
| <img src="docs/assets/screenshots-en/33-theme-11-terminal-green.png" width="420" alt="Theme 11" /><br />#11 终端酸绿 | <img src="docs/assets/screenshots-en/39-theme-20-studio-bw.png" width="420" alt="Theme 20" /><br />#20 摄影棚黑白 |
| <img src="docs/assets/screenshots-en/34-theme-12-deep-ocean.png" width="420" alt="Theme 12" /><br />#12 深海蓝渊 | |
| <img src="docs/assets/screenshots-en/35-theme-17-graphite.png" width="420" alt="Theme 17" /><br />#17 石墨信号 | |
...
```powershell
python tools/capture_readme_shots.py                 # ZH PNGs → docs/assets/screenshots-en/
